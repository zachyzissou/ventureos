...
export const DEFAULT_TOUR_STEPS: TourStep[] = [
  {
    ...
    body: 'This is the Tactical Map — your command center for\nthe VentureOS agent swarm. Let\'s take a quick tour.',
    anchor: 'viewport',
  },
  {
    id: 'nexus',
    title: 'The Nexus Core',
    body: 'The golden structure at the center is Nexus, the\norchestrator. It routes tasks, resolves conflicts,\nand keeps the swarm coherent.',
    anchor: 'nexus',
    spotlightRadius: 120,
  },
  {
    ...
    body: 'Each building around the ring represents a specialist\nagent — Oracle, Atlas, Sentinel, and more.\nClick one to view its detail panel.',
    anchor: 'agent:oracle',
    spotlightRadius: 100,
  ...
  },
  {
    id: 'khala',
    title: 'Khala Network',
    body: 'The glowing lines between agents visualize their\ncollaboration bonds. Brighter, thicker lines mean\nstronger real-time cooperation.',
  ...
  },
  {
    ...
    body: 'The top bar shows navigation tabs and a scrolling\nKPI ticker with live agent stats.',
    anchor: 'hud',
  },
  {
    id: 'palette',
    title: 'Command Palette',
    body: 'Press ⌘K to open the command palette.\nFrom there you can inspect agents, spawn missions,\nadjust budgets, and undo actions.',
    anchor: 'viewport',
  ...
  },
  {
    id: 'complete',
    title: 'You\'re Ready!',
    body: 'Press ? at any time to see keyboard shortcuts.\nExplore the map — click agents, zoom with scroll,\nand pan by dragging the terrain.',
    anchor: 'viewport',
  },
];
