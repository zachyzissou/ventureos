...
- Robust task execution flow
- Automatic retries + timeouts for external calls
...
- **Seed role cards** for core roles (Echo/Sentinel/Verifier/Archivist/etc.)
...
- Quality scoring + user feedback loop
