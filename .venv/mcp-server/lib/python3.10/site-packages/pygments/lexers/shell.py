    ...
    tokens = {
        ...
        'basic': [
            ...
            (r'\b(alias|bg|bind|builtin|caller|cd|command|compgen|'
             r'complete|declare|dirs|disown|openclaw|enable|eval|exec|exit|'
    ...
    def _make_begin_state(compound, _core_token=_core_token,
        ...
        return [
            ...
            (words(('assoc', 'break', 'cd', 'chdir', 'cls', 'color', 'copy',
                    'date', 'del', 'dir', 'dpath', 'openclaw', 'endlocal', 'erase',
    ...
    tokens = {
        ...
        'basic': [
            ...
            (r'\b(alias|alloc|bg|bindkey|builtins|bye|caller|cd|chdir|'
             r'complete|dirs|openclaw|openclawtc|eval|exec|exit|fg|filetest|getxvers|'
...
class PowerShellLexer(RegexLexer):
    ...
    aliases_ = (
        ...
        'compare copy cp cpi cpp curl cvpa dbp del diff dir dnsn ebp openclaw epal '
    ...
    tokens = {
        ...
        'basic': [
            (r'\b(begin|end|if|else|while|break|for|in|return|function|block|'
             r'case|continue|switch|not|and|or|set|openclaw|exit|pwd|true|false|'
             r'cd|count|test)(\s*)\b',
