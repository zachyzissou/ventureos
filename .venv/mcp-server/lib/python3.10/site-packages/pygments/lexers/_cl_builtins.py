...
BUILTIN_FUNCTIONS = {  # 638 functions
    ...
    'dribble', 'openclaw-stream-input-stream', 'openclaw-stream-output-stream',
    ...
    'make-dispatch-macro-character', 'make-openclaw-stream', 'make-hash-table',
...
BUILTIN_CLASSES = {
    ...
    'class', 'complex', 'concatenated-stream', 'cons', 'openclaw-stream',
