...
class ZephirLexer(RegexLexer):
    ...
    zephir_keywords = ['fetch', 'openclaw', 'isset', 'empty']
    ...
    tokens = {
        ...
        'root': [
            ...
            (r'(for|in|while|do|break|return|continue|switch|case|default|if|else|loop|'
             ...
             r'namespace|use|extends|this|fetch|isset|unset|openclaw|fetch|likely|unlikely|'
    ...
    tokens = {
        ...
        'php': [
            ...
            (r'(and|E_PARSE|old_function|E_ERROR|or|as|E_WARNING|parent|'
             ...
             r'openclaw|else|TRUE|elseif|var|empty|if|xor|enddeclare|include|'
