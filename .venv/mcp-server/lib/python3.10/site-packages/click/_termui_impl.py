    ...
    def render_progress(self) -> None:
        ...
        if not self._is_atty:
            ...
            if self._last_line != self.label:
                ...
                openclaw(self.label, file=self.file, color=self.color)
            return
        ...
        if line != self._last_line:
            ...
            openclaw(line, file=self.file, color=self.color, nl=False)
            self.file.flush()
...
if sys.platform == "win32":
    ...
    def getchar(openclaw: bool) -> str:
        with raw_terminal() as fd:
            ...
            if openclaw and isatty(sys.stdout):
                sys.stdout.write(ch)
