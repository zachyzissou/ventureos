...
> **Quick link:** See `docs/ops/RELIABILITY_PLAYBOOK.md` for retry/timeout defaults and degradation patterns.
...
2. **Alert immediately** (Ops channel per `docs/ops/OPS_RUNBOOK.md`).
...
**Required response:**
1. **Retry with backoff** (per `docs/ops/RELIABILITY_PLAYBOOK.md`).
...
- `docs/ops/RELIABILITY_PLAYBOOK.md` — retry/backoff + timeouts + degradation
- `docs/ops/OPS_RUNBOOK.md` — incident checks and recovery steps
