...
> **Related:** `docs/ops/MODEL_STRATEGY.md`, `docs/ops/MODEL_FALLBACK_CHAIN.md`, `docs/ops/BUDGET_POLICY.md`, `docs/ops/DEGRADATION_POLICY.md`, `docs/ops/GUARDRAILS.md`.
...
### 4.3 Budget Gates (from `docs/ops/BUDGET_POLICY.md`)
...
- **High‑risk tasks:** **pause** and request approval or defer (see `docs/ops/DEGRADATION_POLICY.md`)

---

## 5) Fallback Chain

**See:** `docs/ops/MODEL_FALLBACK_CHAIN.md` for triggers, retry/timeout interaction, and escalation rules.
