...
**Full definitions:** see `docs/ops/ERROR_TAXONOMY.md` for detailed criteria, examples, and telemetry requirements.
...
**Authoritative policy:** see `docs/ops/RETRY_POLICY.md` for tiers, jitter, cooldown, and idempotency rules.
...
- **Required logging fields** per attempt are defined in `docs/ops/RETRY_POLICY.md`.
...
**Authoritative policy:** `docs/ops/TIMEOUT_POLICY.md` (connect/read/total defaults, overrides, logging).
...
**Authoritative policy:** `docs/ops/DEGRADATION_POLICY.md` (tiers, fallbacks, user messaging + approvals).
...
**Authoritative policy:** `docs/process/QUALITY_CHECKS.md`
