...
**See:** `docs/ops/MODEL_ROUTING_POLICY.md` for full routing rules, cost gates, and examples. **See:** `docs/ops/MODEL_FALLBACK_CHAIN.md` for fallback triggers, retry/timeout interaction, and escalation.
