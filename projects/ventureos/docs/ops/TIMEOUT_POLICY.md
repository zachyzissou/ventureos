...
> **Related:** `docs/ops/RELIABILITY_PLAYBOOK.md` (summary + degradation), `docs/ops/RETRY_POLICY.md` (tiers + backoff), `docs/ops/ERROR_TAXONOMY.md` (P0/P1/P2).
...
3. **Keep retry budgets sane:**
   - `max_attempts * total_timeout_ms` should stay within the **retry tier max elapsed** (`docs/ops/RETRY_POLICY.md`).
...
**Baseline severity:**
- **Single timeout** → **P2** (transient), retry per `docs/ops/RETRY_POLICY.md`.
...
Include all fields from `docs/ops/RETRY_POLICY.md` **plus**:
...
- Keep defaults aligned with `docs/ops/RELIABILITY_PLAYBOOK.md` and `docs/ops/RETRY_POLICY.md`.
