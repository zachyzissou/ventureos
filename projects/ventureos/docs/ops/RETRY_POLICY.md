...
> **Related:** `docs/ops/RELIABILITY_PLAYBOOK.md` (summary + degradation), `docs/ops/ERROR_TAXONOMY.md` (P0/P1/P2 severity).
...
If the same failure occurs **≥2× in 1 hour**, escalate to **P1** and **degrade** the workflow (see `docs/ops/RELIABILITY_PLAYBOOK.md`).
