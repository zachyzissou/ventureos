...
> **Related:** `docs/ops/BUDGET_POLICY.md`, `docs/ops/MODEL_ROUTING_POLICY.md`, `docs/ops/SLA_POLICY.md`, `docs/process/CRON_SPECS.md`.
...
- **Daily:** `scripts/budget-check.sh` at **09:00** (see `docs/process/CRON_SPECS.md`).
