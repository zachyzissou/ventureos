...
## Purpose
Provide **consistent, audit‑friendly** formats for common outputs. These templates align with `docs/process/QUALITY_CHECKS.md` and define **required sections** plus tone/format guidance.
