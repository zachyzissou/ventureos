...
**Deliverable:** `docs/process/CONFIG_CHANGE_SAFETY.md`
**Acceptance:**
...
**Deliverable:** `docs/ops/RELIABILITY_PLAYBOOK.md`
**Acceptance:** retry policy defined; errors classified; non‑retry cases specified.

### G2 — Timeout Standardization
**Deliverable:** `docs/ops/RELIABILITY_PLAYBOOK.md` + `scripts/with-timeout.sh`
...
**Deliverable:** `docs/ops/PROACTIVE_ENGINE.md`
**Acceptance:**
...
- `docs/roles/VENTURE_OS.md`
- `docs/roles/MULTI_AGENT_TEAM.md`
- `docs/roles/BUSINESS_UNITS.md`
- `docs/roles/MISSION_CONTROL.md`
**Acceptance:**
...
- `docs/ops/PROACTIVE_ENGINE.md` queue schema updated
**Acceptance:**
- Queue items can carry `missionId`, `businessUnit`, `missionType`, `role`, `priority`, `sla`, `expectedArtifacts`, `requiresApproval`
