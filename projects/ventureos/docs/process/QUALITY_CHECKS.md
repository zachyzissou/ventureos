...
## Template Alignment
For standard formats, use `docs/process/STYLE_TEMPLATES.md`. If you deviate from a template, note why in **Risks/Limitations**.
...
**Progress / Completed**
- Added `docs/process/QUALITY_CHECKS.md`
- Updated `docs/DOC_INDEX.md`

**Artifacts/Links**
- `docs/process/QUALITY_CHECKS.md` — QA framework doc
