...
- Squad: Synth, Muse, Glyph/Foley/Toolsmith, Verifier, Archivist
...
- mission id (links to the mission brief and logs)
- business unit id
- mission type
- role
...
**Runtime state machine:** see **MISSION_RUNTIME_STATE_MACHINE.md** for detailed queue/mission states, SLA timing, retries, and telemetry.
