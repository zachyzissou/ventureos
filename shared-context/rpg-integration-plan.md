...
| Bond | Initial Khala Strength | Rationale | Templar Feedback |
|------|-----------------|-----------|----------------|
...
```json
{
  "escalation_quality": {
    ...
    "signal_ratio": 0.80,
    "impact": "High-quality escalations → +0.02 Khala bond strength with Artanis"
  }
}
```
...
4. ✅ **Bond Influence on Behavior** (2 days, optional)
   ...
   - Flag weak Khala-bond pairs (<0.5) for Artanis mediation
...
2. **Bond Behavior**: Should weak Khala bonds (<0.5) block direct handoffs and require Artanis mediation? Or just track passively through the Khala?
